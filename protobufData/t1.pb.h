...
class Student final :
 ...
 public:
  ...
  // bytes subjects = 3;
  void clear_subjects();
  const std::string& subjects() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_subjects(ArgT0&& arg0, ArgT... args);
  std::string* mutable_subjects();
  PROTOBUF_NODISCARD std::string* release_subjects();
  void set_allocated_subjects(std::string* subjects);
  private:
  const std::string& _internal_subjects() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_subjects(const std::string& value);
  std::string* _internal_mutable_subjects();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr subjects_;
    int32_t age_;
...
inline void Student::clear_subjects() {
  _impl_.subjects_.ClearToEmpty();
}
inline const std::string& Student::subjects() const {
  // @@protoc_insertion_point(field_get:Student.subjects)
  return _internal_subjects();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Student::set_subjects(ArgT0&& arg0, ArgT... args) {
 
 _impl_.subjects_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Student.subjects)
}
inline std::string* Student::mutable_subjects() {
  std::string* _s = _internal_mutable_subjects();
  // @@protoc_insertion_point(field_mutable:Student.subjects)
  return _s;
}
inline const std::string& Student::_internal_subjects() const {
  return _impl_.subjects_.Get();
}
inline void Student::_internal_set_subjects(const std::string& value) {
  
  _impl_.subjects_.Set(value, GetArenaForAllocation());
}
inline std::string* Student::_internal_mutable_subjects() {
  
  return _impl_.subjects_.Mutable(GetArenaForAllocation());
}
inline std::string* Student::release_subjects() {
  // @@protoc_insertion_point(field_release:Student.subjects)
  return _impl_.subjects_.Release();
}
inline void Student::set_allocated_subjects(std::string* subjects) {
  if (subjects != nullptr) {
    
  } else {
    
  }
  _impl_.subjects_.SetAllocated(subjects, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.subjects_.IsDefault()) {
    _impl_.subjects_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Student.subjects)
}

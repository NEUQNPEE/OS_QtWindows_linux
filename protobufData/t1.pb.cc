...
PROTOBUF_CONSTEXPR Student::Student(
  ...
  , /*decltype(_impl_.subjects_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
Student::Student(const Student& from)
  ...
  _impl_.subjects_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.subjects_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_subjects().empty()) {
    _this->_impl_.subjects_.Set(from._internal_subjects(), 
      _this->GetArenaForAllocation());
  }
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          auto str = _internal_mutable_subjects();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Student::_InternalSerialize(
  ...
  // bytes subjects = 3;
  if (!this->_internal_subjects().empty()) {
    target = stream->WriteBytesMaybeAliased(
        3, this->_internal_subjects(), target);
  }
...
void Student::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_subjects().empty()) {
    _this->_internal_set_subjects(from._internal_subjects());
  }
...
void Student::InternalSwap(Student* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.subjects_, lhs_arena,
      &other->_impl_.subjects_, rhs_arena
  );
